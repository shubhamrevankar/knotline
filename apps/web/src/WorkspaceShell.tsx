...
export function WorkspaceShell({
  ...
  return (
    <WorkspaceShellContext.Provider value>
      <div
        className={`app-shell app-shell--activation${collapsed ? " app-shell--collapsed" : ""}`}
      >
      <aside
      ...
      >
        ...
        <Link className="workspace-switcher" title="Northstar Studio" to="/app/settings/workspace">
          <span aria-hidden="true" className="workspace-avatar">N</span>
          <span className="sidebar-label"><strong>Northstar Studio</strong></span>
        ...
        <div className="sidebar-section">
          ...
          <Link className="nav-item" title={collapsed ? "Running now" : undefined} to="/app/runs?status=running">
        ...
        <div className="sidebar-footer">
          ...
          <Link className="nav-item" title={collapsed ? "Workspace settings" : undefined} to="/app/settings/workspace">
            <Settings2 aria-hidden="true" size={17} />
            <span className="sidebar-label">Workspace settings</span>
          </Link>
          <Link className="profile" title={collapsed ? "Maya Chen" : undefined} to="/app/profile/sessions">
            <span aria-hidden="true" className="profile-avatar">MC</span>
            <span className="sidebar-label"><strong>Maya Chen</strong><small>maya@northstar</small></span>
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div className="top-actions">
            <span className={connected ? "connection connection--live" : "connection"} role="status">
              <i aria-hidden="true" />
      ...
      <nav className="mobile-bottom-nav" aria-label="Mobile navigation">
        <Link aria-current={location.pathname.startsWith("/app/workflows") ? "page" : undefined} to="/app/workflows">
          <Blocks aria-hidden="true" size={18} /> Workflows
        </Link>
        <Link aria-current={location.pathname.startsWith("/app/runs") ? "page" : undefined} to="/app/runs">
